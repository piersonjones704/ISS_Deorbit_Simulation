...
if __name__ == '__main__':
    # Test cases:
    do_test(130, 'km', 7800, 0, 0.1, 'hit_ground')
    ...
    do_test(150, 'km', 7800, 0, 0.1, 'hit_ground')
    ...
    do_test(130, 'km', 7800, -30, 0.1, 'hit_ground')
    ...
    do_test(140, 'km', 8000, -10, 0.1, 'hit_ground')
    ...
    do_test(140, 'km', 8000, -150, 0.1, 'hit_ground')
    ...
    do_test(130000, 'm', 7800, 0, 0.1, 'hit_ground')
    ...
    do_test(80.7783, 'miles', 7800, 0, 0.1, 'hit_ground')
